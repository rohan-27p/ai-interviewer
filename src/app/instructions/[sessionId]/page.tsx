            ...
            <main className="relative z-10 max-w-3xl mx-auto px-6 py-12">
                ...
                <div className="space-y-4 mb-8">
                    ...
                    <div className="p-5 bg-white/5 border border-white/10 rounded-xl flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold mb-1">Interactive AI Interviewer</h3>
                            <p className="text-sm text-[#a0a0a5]">
                    ...
                    {/* Navigation Warning */}
                    <div className="p-5 bg-orange-500/10 border border-orange-500/30 rounded-xl flex items-start gap-4">
                        <div className="w-10 h-10 rounded-lg bg-orange-500/20 flex items-center justify-center flex-shrink-0">
                            <AlertTriangle className="w-5 h-5 text-orange-400" />
                        </div>
                        <div>
                            <h3 className="font-semibold mb-1 text-orange-300">Important Session Rules</h3>
                            <ul className="text-sm text-[#a0a0a5] space-y-2 mt-2">
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full"></span>
                                    <span>Do <strong className="text-orange-300">NOT</strong> navigate away, go back, or forward during the interview</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full"></span>
                                    <span>Do <strong className="text-orange-300">NOT</strong> refresh or close the browser tab</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full"></span>
                                    <span>Do <strong className="text-orange-300">NOT</strong> open the interview in another tab or window</span>
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-orange-400 rounded-full"></span>
