...
export default function FeedbackListPage() {
    ...
    const getVerdictColor = (verdict: string) => {
        ...
        if (verdict.includes('Lean No')) return 'text-orange-400';
        return 'text-red-400';
    };
                        ...
                        <div className="grid gap-4">
                            {feedbackList.map((fb) => (
                                <Link
                                    ...
                                    className="group block p-6 bg-white/5 border border-white/10 rounded-2xl hover:border-orange-500/50 hover:bg-white/10 transition-all"
                                >
                                    <div className="flex items-start gap-6">
                                        ...
                                        <div className="flex items-center self-center">
                                            <ChevronRight className="w-5 h-5 text-[#6b6b70] group-hover:text-orange-400 transition-colors" />
                                        </div>
                                    </div>
                                </Link>
                            ))}
